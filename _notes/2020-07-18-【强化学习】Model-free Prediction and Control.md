...
![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1595813818512.png)


TD(0)方法用于估计value function　V(S)

$$A_t \leftarrow 给定\pi， 为S找到action$$

$$采用action \quad A_t， 观察 R_{t+1} 和 S_{t+1}$$
