...
我们提出了ERNIE-ViLG，将双向的图像-文本生成任务统一在一个生成模型中，并提出了一种端到端的文本-图像生成训练方法。

ERNIE-ViLG在大规模图像-文本数据集上进行了预训练，捕捉了双向视觉-语言生成的能力，并在各种跨模态生成任务(包括文本-图像合成、图像字幕和生成视觉回答)上取得了卓越的性能。

总之，该模型进一步推进了图像到文本和文本到图像生成任务的统一预训练。
