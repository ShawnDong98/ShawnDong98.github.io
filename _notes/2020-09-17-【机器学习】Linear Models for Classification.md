---
layout:     post
title:      "【机器学习】Linear Models for Classification"
subtitle:   ""
date:       2020-09-17
author:     "ShawnD"
...
三种线性模型，第一种是linear classification。线性分类模型的hypothesis为$h(x) = sign(s)$, 取值范围为\{-1,+1\}两个值，它的err是0/1的，所以对应的$E_{in}(w)$是离散的，并不好解，这是个NP-hard问题。
...
![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600310521137.png)
...
对于logistics regression， 它的error function可以写成：

$$err_{CE}(s, y) = ln(1 + exp(-ys))$$

上述三种模型的error function都引入了ys变量，那么ys的物理意义是什么？ys就是指 分类的正确率得分，其值越大越好，得分越高。

![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600323175743.png)

下面，我们用图形化的方式来解释三种模型的error function到底有什么关系：

![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600323199834.png)
...
![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600324301194.png)
...
![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600325000804.png)
...
![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600326225239.png)
...
![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600327062219.png)
...
![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600327511686.png)

对于logistic regression的SGD，它的表达式为：

$$w_{t+1} \leftarrow w_t + \eta \theta (-y_n w_t^T x_n)(y_nx_n)$$

我们发现，SGD与PLA的迭代公式有类似的地方，如下图所示：

![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600327620370.png)
...
![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600327776781.png)
...
![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600327937024.png)
...
![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600328269396.png)
...
![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600328329502.png)
...
![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600328730730.png)

这种区别于OVA的多分类方法叫做One­Versus­One(OVO)。这种方法的优点是更加高 效，因为虽然需要进行的分类次数增加了，但是每次只需要进行两个类别的比较，也 就是说单次分类的数量减少了。而且一般不会出现数据unbalanced的情况。缺点是需 要分类的次数多，时间复杂度和空间复杂度可能都比较高。

![](https://raw.githubusercontent.com/ShawnDong98/ShawnDong98.github.io/master/小书匠/1600328771245.png)
