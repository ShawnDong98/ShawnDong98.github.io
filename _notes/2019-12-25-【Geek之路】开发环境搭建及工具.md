...
- (a) 打开文件
- (b) 查找关键词， 进入配置文件后查找关键词“c.NotebookApp.notebook_dir”。
- (c) 编辑配置文件 取消注释, 将你想修改的路径填进去
- (d) 保存配置文件
...
接着在 `~/.jupyter/jupyter_notebook_config.py` 文件中修改 `c.NotebookApp.password`
...
![](https://raw.githubusercontent.com/ShawnDong98/gitimage/main/小书匠/1637704109884.png)
...
![](https://raw.githubusercontent.com/ShawnDong98/gitimage/main/小书匠/1637704684083.png)
...
![](https://raw.githubusercontent.com/ShawnDong98/gitimage/main/小书匠/1637705587813.png)
...
[https://download.typora.io/mac/Typora-0.11.18.dmg](https://download.typora.io/mac/Typora-0.11.18.dmg)
...
![](https://raw.githubusercontent.com/ShawnDong98/gitimage/main/小书匠/1640158271312.png)
...
下载并安装 [Conda env](https://github.com/conda-forge/miniforge/releases/latest/download/Miniforge3-MacOSX-arm64.sh)
...
安装了插件 Markdown All In One ([https://marketplace.visualstudio.com/items?itemName=markdown-all-in-one.markdown-all-in-one](https://marketplace.visualstudio.com/items?itemName=markdown-all-in-one.markdown-all-in-one))，快捷键有冲突。
...
![](https://raw.githubusercontent.com/ShawnDong98/gitimage/main/小书匠/1669086100461.png)
...
[https://developer.nvidia.com/cuda-11.2.0-download-archive?target_os=Linux&target_arch=x86_64&target_distro=Ubuntu&target_version=1804&target_type=deblocal](https://developer.nvidia.com/cuda-11.2.0-download-archive?target_os=Linux&target_arch=x86_64&target_distro=Ubuntu&target_version=1804&target_type=deblocal)
...
推荐安装 [cuDNN Library for Linux (x86_64)](https://developer.nvidia.com/compute/machine-learning/cudnn/secure/8.1.0.77/11.2_20210127/cudnn-11.2-linux-x64-v8.1.0.77.tgz)
...
![](https://raw.githubusercontent.com/ShawnDong98/gitimage/main/小书匠/1704881546028.png)
...
58. [https://vimawesome.com/](https://vimawesome.com/)
59. [如何更改VIM切换窗口的默认键盘快捷键？](http://cn.voidcc.com/question/p-zaioucxu-bev.html)
60. [Mac-Neovim-Coc配置和常用快捷键](https://juejin.cn/post/6968807773366976549)
61. [iTerm2 都不会用，还敢自称老司机？](https://zhuanlan.zhihu.com/p/112383265?from_voters_page=true)
62. [解决 VSCode Markdown 文件中无法接受Copilot建议的问题](https://tutorials.maiyatang.co/vscode/sovle-copilot-can-not-accept-in-markdown.html#%E8%A7%A3%E5%86%B3%E6%96%B9%E6%A1%88)
63. [Getting Started with tensorflow-metal PluggableDevice](https://developer.apple.com/metal/tensorflow-plugin/)
64. [Module 'tensorflow.tools.docs.doc_controls' has no attribute 'inheritable_header'](https://stackoverflow.com/questions/69794473/module-tensorflow-tools-docs-doc-controls-has-no-attribute-inheritable-header)
65. [ubuntu 永久 设置 降低N显卡功率 nvidia-smi](https://www.csdn.net/tags/MtTaAgysMjAxMDIzLWJsb2cO0O0O.html)
66. [macOS Ventura beta 6 Safari 浏览器自带翻译异常 ](https://github.com/yichengchen/clashX/discussions/964)
67. [linux环境下使用命令行，从百度网盘上传、下载数据](https://blog.csdn.net/weixin_42232041/article/details/106816582)
68. [禁止ubuntu自动更新显卡驱动](https://blog.csdn.net/zsgcsdn/article/details/134824208)