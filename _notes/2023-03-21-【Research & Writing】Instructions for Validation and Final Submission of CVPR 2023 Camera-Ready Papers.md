...
**IMPORTANT:** 一旦您提交了IEEE电子版权表格，您将无法进行更改。IEEE没有任何“redo”电子版权表格的机制，您无法为每篇论文填写一个以上的表格。因此，在填写和提交 IEEE 电子版权表格之前，请确保标题、作者列表（包括顺序）等（如第3步所述）在OpenReview中正确无误。

要完成 camera-ready 提交，您必须填写 IEEE  Electronic Copyright  表格。为此，请按 OpenReview “Author Console” 中您接受的论文中列出的 “Copyright Submission” 按钮，然后按照说明填写和提交版权表格。在此过程中，您将被转移到IEEE网站，以填写并提交版权表格。同样，版权表格每篇论文只能填写一次，因此在提交之前，请确保表格上的所有信息都是完整和最终的（包括对论文标题和作者顺序的更改）。这必须在2023年3月24日的最后期限前完成。

没有完整版权表格的论文将不会出现在会议记录中，也不会注册IEEE Xplore。

**最后提醒：** 论文将出现在CVPR 2023程序中，并且只有在满足所有这些条件的情况下才会被放置在IEEE Xplore中：

- 最终提交的PDF大小为10MB或更少，长度为8页（不包括引用的参考资料）或更少，已由 PDF eXpress 验证，经过验证的论文已于2023年3月24日太平洋夏令时间晚上11:59上传到 Paper 收集网站。
- 任何补充材料文件（如果适用）已于2023年3月24日上传到提交网站。
- 至少有一位作者注册并参加了CVPR 2023。
- IEEE Electronic Copyright  表格在线填写并提交给论文收集网站。


**Note:** 请注意，你的论文是否被接受的条件是 通过 iThenticate 剽窃检查。