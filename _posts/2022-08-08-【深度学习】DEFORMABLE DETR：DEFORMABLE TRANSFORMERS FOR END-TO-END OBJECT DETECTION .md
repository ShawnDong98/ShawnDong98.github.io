...
**Deformable Attention Module.**  在图像上应用 Transformer attention特征图的核心问题是，它将查看所有可能的空间位置。为了解决这个问题， 作者提出 deformable attention 模块。受启发与 deformable convolution， deformable attention 模块只关注参考点周围的一小部分关键采样点，无论特征图的空间大小如何，如图2所示。
