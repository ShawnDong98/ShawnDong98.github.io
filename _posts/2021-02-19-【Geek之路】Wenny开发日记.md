...
Wenny是一款基于传感器的、易于唤醒的、主动式的、温暖的人工智能助手。
...
温暖的， 人工智能助手不应该是仅为主体提供服务的冰冷的机器。 Wenny基于当前的时间以及过去主体的生活习惯， 在适时向主体发出问候。 例如，清晨时， 基于日期和闹钟等预测主体起床时间， 播放音乐帮助主体起床；例如，当监测到主体久坐到下午茶时间时， 询问是否需要点下午茶；例如， 午饭、晚饭时基于评价向主体推荐不同的美食。
