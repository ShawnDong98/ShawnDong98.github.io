...
- **Network Design:** Backbone: 与其他主流架构相比，作者发现RepVGG [3]主干以类似的推理速度在小型网络中配备了更多的表征能力，而由于参数的爆炸性增长和计算成本，它几乎无法扩展到以获得更大的模型。在这方面，作者将RepBlock[3]作为作者建设小型网络的 block。对于大型网络，作者修改了一个更高效的CSP [43] block，名为CSPStackRep 块。
