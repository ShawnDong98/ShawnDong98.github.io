...
图像去雾的一个主要挑战是如何验证所提出的方法。尽管数量众多，种类繁多，但图像去雾的质量在许多时候都是有争议的。因此，确定它们的局限性和新的研究方向相当困难。图像去雾领域仍然缺乏标准化的基准，无法对去雾技术进行客观和定量性能评估。基本上，客观评估图像去雾性能的一个主要问题是缺乏参考无雾图像。

收集一对有雾和相应的无雾图像是一项繁琐的任务，因为这两种图像（雾和无雾）都需要在相同的条件下捕获。