...
我们在几个具有挑战性的图像基准上展示了一致性模型的有效性，包括CIFAR-10（Krizhevsky等人，2009年）、ImageNet 64 x 64（Deng等人，2009年）和LSUN 256 ˆx256（Yu等人，2015年）。经验上，我们观察到，作为一种蒸馏方法，一致性模型在各种数据集和采样步骤中优于渐进式蒸馏（Salimans & Ho，2022年）。在CIFAR-10上，一致性模型在一步和两步生成中达到了3.55和2.93的新的最先进的FID。在ImageNet 64 x 64上，它分别通过一次和两次网络评估，实现了创纪录的 6.20 和 4.70 的FID。