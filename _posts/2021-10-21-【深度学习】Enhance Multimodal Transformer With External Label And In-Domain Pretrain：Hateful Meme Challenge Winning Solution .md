...
此外，hateful memes 建立在不同的主题上，通常包含没有现成的分类器能识别的新物体，这与在典型的多模态数据集中呈现的日常物体有很大不同。例如injury， traditional costume wear by the subject，  historical scenes等视觉暗示难以识别并且样本数量少。