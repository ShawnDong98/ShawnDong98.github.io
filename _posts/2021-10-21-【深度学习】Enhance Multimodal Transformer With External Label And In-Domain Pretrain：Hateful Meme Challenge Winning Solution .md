...
![](https://raw.githubusercontent.com/ShawnDong98/gitimage/main/小书匠/1634807328037.png)


## ERNIE-Vil 

ERNIE-Vil 是基于从场景图中提取的信息进行预训练的 VL 模型，用于教模型关于细粒度对象属性和关系模型。ERNIE-Vil作为VCR排行榜上的STOA模型，通过一些超参数调整，可以实现与经过拓展的VL-BERT和UNITER-ITM的相竞争的性能。