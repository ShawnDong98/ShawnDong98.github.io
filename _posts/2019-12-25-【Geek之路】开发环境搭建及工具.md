...
ps：如下这种环境变量的写法会导致安装程序是出现 ':/usr/local/cuda/bin/nvcc' failed with exit status 1：
...
44. [修改Ubuntu的环境变量\$PATH](https://www.cnblogs.com/oceanking/archive/2012/09/02/2667362.html)