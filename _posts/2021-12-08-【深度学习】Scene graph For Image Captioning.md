...
我们提出了 Scene Graph Auto-Encoder (SGAE)，将 language inductive bias 整合到encoder-decoder image captioning 框架中，以获得更 human-like 的 captions。直觉上， 我们人类在固定搭配和上下文推理之中使用 inductive bias。 例如， 当我们看到 “person on bike” 的关系， 我们很自然地会想到替换 "on" 为 “ride”， 并且推理出 infer “per-son riding bike on a road”， 即便 "road" 并不明显出现。