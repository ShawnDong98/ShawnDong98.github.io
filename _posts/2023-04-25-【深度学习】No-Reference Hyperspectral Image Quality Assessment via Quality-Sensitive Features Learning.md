...
据我们所知，没有关于 HSI 重建的无参考质量评估的出版工作。Alparone等人在[14]中提出了一种无参考全色图像评估方法，其需要高分辨率全色图像来评估重建的多光谱图像。此方法不适用于全色图像不可用的情况。还有其他一些为彩色图像设计的无参考图像评估方法[15-17]，但它们不能直接应用于高光谱图像。
