...
**Multi-modal label-to-image synthesis.** 在多模态标签到图像合成任务中，已经有许多工作\[1，28，40\]。Chen等人\[4\]避免使用GAN和利用级联优化网络生成高分辨率图像。Wang等人\[41\]在编码器的输出中添加了额外的实例级特征通道，允许对生成的结果进行对象级控制。Wang等人\[40\]使用另一种源图像作为风格样本来指导生成过程。Park等人\[36\]将VAE整合到他们的网络中，使生成器能够产生多模态图像。Park等人\[36\]将VAE整合到他们的网络中，使发生器能够产生多模态图像。
