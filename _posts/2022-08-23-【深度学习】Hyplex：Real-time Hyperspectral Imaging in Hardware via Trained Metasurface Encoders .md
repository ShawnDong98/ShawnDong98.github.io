...
为了训练和验证HyplexTM系统，作者使用三个公开的数据集：CAVE数据集，由32张涵盖 400nm 至 700 nm的室内图像组成，以及 Harvard 和 KAUST 数据集，其中包含室内和室外场景，规格为75张和409张图像，光谱带分别覆盖420 nm 至 720nm 和 400 nm 至 700 nm。
