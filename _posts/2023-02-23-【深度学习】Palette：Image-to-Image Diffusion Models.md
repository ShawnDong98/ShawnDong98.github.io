...
重要的是，我们倡导基于 ImageNet 的统一评估协议，其中包含人类评估和样本质量分数（FID、Inception Score、预训练的ResNet-50的分类准确性以及针对原始图像的感知距离）。

我们预计这种标准化的评估协议将在推进图像到图像的翻译研究中发挥作用。最后，我们表明，多任务扩散模型的性能与特定任务的专家模型一样好或更好。
