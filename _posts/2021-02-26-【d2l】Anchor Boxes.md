...
我们知道，在目标检测训练集中，每一幅图像都有标记ground-truth边界框的位置和包含的目标类别。Anchor框生成后，我们主要根据与Anchor框相似的ground-truth边界框的位置和category信息对Anchor框进行标签。那么我们如何分配ground-truth边界框到类似的Anchor框呢？
