...
作者通过与各种竞争性无监督方法进行比较，如深度生成先验、SNIPS和去噪正则化，展示了DDRM的有效性。在 ImageNet 样本中，DDRM在PSNR和KID度量的无噪声超分辨率和去模糊下大多优于神经网络基线，当它位居第二时，其NFE的效率至少高出50倍。当涉及观测噪声时，我们的优势会变得更大，因为迭代方法产生的噪声瑕疵不会出现在我们的情况下。