...
这篇文章提出了一种用于图像去模糊的Deep Resual Fourier Transformation(DeepRFT)，其中提出了一种即插即用的残差块，称为 Res FFT-Conv 块，集成了空间和频率残差信息。Res FFT-Conv Block允许 image-wide 的感受野，能够捕获长程的相互作用。通过插入 Res FFT-Conv Block 到 MIMO-UNet， DeepRFT 取得了 SOTA 性能。
