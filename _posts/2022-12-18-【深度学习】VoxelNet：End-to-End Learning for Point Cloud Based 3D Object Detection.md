...
**Evaluation in Bird’s Eye View** 评估结果见表1。VoxelNet在所有三个难度级别的表现一直优于所有竞争方法。HC基线还实现了与最先进的[5]相当的令人满意的性能，这表明基础区域提议网络（RPN）是有效的。对于鸟瞰图中的行人和非机动车检测任务，作者将拟议的VoxelNet与HC基线进行了比较。
