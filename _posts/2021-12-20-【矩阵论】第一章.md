...
$$
S_1 = \left{A \mid A = \left{a_{ij}\right}_{2 \times 2}, a_{11} + a_{22} = 0 \right}
$$
...
$$
V_1 + V_2 = \left{y + z \mid y \in V_1, z \in V_2
...
$$
V_1 = \left{(\xi_1, \xi_2, \xi_3, \xi_4) \mid \xi_1 - \xi_2 + \xi_3 - \xi_4 = 0


right} \\
V_2 = \left{(\xi_1, \xi_2, \xi_3, \xi_4) \mid \xi_1 + \xi_2 + \xi_3 + \xi_4 = 0
...
**1.1.12**： 给定 $R^{2 \times 2} = \left{A = (a_{ij})_{2 \times 2} \mid a_{ij} \in R


right}$（数域 $R$ 上的2阶实方阵按通常矩阵的加法与数乘矩阵构成的线性空间）的子集

$$
V = \left{A = (a_{ij})_{2 \times 2} \mid a_{ij} \in R \text{ and }  a_{11} + a_{12} = 0
...
$$
V_1 = \left{A = (a_{ij})_{2 \times 2} \mid a_{ij} = a_{ji}, a_{ij} \in R


right} \\
V_2 = \left{B = (b_{ij})_{2 \times 2} \mid b_{ij} = -b_{ji}, b_{ij} \in R
...
$$
A = \left{(a_{ij})_{2 \times 2} \mid a_{ij} = a_{ji}, a_{ij} \in R 


right} \in V$， $B = \left{(b_{ij})_{2 \times 2} \mid b_{ij} = b_{ji}, b_{ij} \in R 
...
所以 $V_1 \cap V_2 = \left{O\r

right}$， 即 $V = V_1 \oplus V_2$。
...
$$
V_{\lambda_0} = \left{x \mid Tx = \lambda_0x, x \in V^n
...
$$
其中 $N_i = \left{x \mid (T - \lambda_i T_e)^{m_i}x = 0, x \in V^n


right}$， 是线性变换  $(T - \lambda_i T_e)^{m_i}$ 的核子空间。
...
**1.1.11**： 求 $R^4$ 的子空间
$$
V_1 = \left{(\xi_1, \xi_2, \xi_3, \xi_4) \mid \xi_1 - \xi_2 + \xi_3 - \xi_4 = 0\right} \\
V_2 = \left{(\xi_1, \xi_2, \xi_3, \xi_4) \mid \xi_1 + \xi_2 + \xi_3 + \xi_4 = 0\right}
$$
...
**1.1.12**： 给定 $R^{2 \times 2} = \left{A = (a_{ij})_{2 \times 2} \mid a_{ij} \in R \right}$（数域 $R$ 上的2阶实方阵按通常矩阵的加法与数乘矩阵构成的线性空间）的子集

$$
V = \left{A = (a_{ij})_{2 \times 2} \mid a_{ij} \in R \text{ and }  a_{11} + a_{12} = 0 \right}
$$
...
right} \\
V_2 = \left{B = (b_{ij})_{2 \times 2} \mid b_{ij} = -b_{ji}, b_{ij} \in R \right}
$$
...
设 $A = \left{(a_{ij})_{2 \times 2} \mid a_{ij} = a_{ji}, a_{ij} \in R \right} \in V$， $B = \left{(b_{ij})_{2 \times 2} \mid b_{ij} = b_{ji}, b_{ij} \in R  \right} \in V$
