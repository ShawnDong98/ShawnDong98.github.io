...
我们在最流行的目标检测数据集之一 COCO 上评估了DETR，并与一个非常有竞争力的Faster R-CNN基线进行了对比。自最初发表以来，Faster R-CNN经历了多次设计迭代，其性能得到了极大提升。我们的实验表明，我们的新模型达到了可比的性能。更确切地说，DETR在大目标上的表现显著更好，这可能得益于Transformer的非局部计算。然而，在小目标上的性能较低。我们预计未来的工作将以类似于 FPN 对 Faster R-CNN 的改进方式来改进这一方面。
