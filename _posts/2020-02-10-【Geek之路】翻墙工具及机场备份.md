...
## Bug: login to server failed: EOF


在 \[common\] 加一个`tls_enable=true`
...
9. [# frpc客户端连接会提示 login to server failed: EOF](https://blog.csdn.net/qq_41457272/article/details/126833901)