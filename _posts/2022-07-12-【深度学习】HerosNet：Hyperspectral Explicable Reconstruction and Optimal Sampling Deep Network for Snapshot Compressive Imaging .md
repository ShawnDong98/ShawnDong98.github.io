...
随着人工智能和机器人的发展，近年来对捕获和感知高光谱图像的需求急剧增加。基于传统的压缩感知（CS）[51，54]，光谱快照压缩感知（SCI）系统旨在通过二维探测器记录 3D 场景。它具有低带宽、低成本和高数据吞吐量的优势，这在广泛的应用中发挥了越来越重要的作用，如遥感、物体检测、超分辨率和医疗诊断[2,8,14,18,25,36,38,55]。
