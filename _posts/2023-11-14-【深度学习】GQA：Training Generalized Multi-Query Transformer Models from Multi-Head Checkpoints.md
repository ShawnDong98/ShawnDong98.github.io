...
然而，多查询关注（MQA）可能导致质量下降和训练不稳定，训练针对质量和推理优化的单独模型可能不可行。此外，虽然一些语言模型已经使用多查询注意力，如PaLM（Chowdhery等人，2022年），但许多没有，包括公开可用的语言模型，如T5（Raffel等人，2020年）和LMAMA（Touvron等人，2023年）。
