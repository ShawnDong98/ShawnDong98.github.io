...
总体而言，该方法产生了各种合理且逼真的结果，同时在多个标准数据集的失真和感知质量方面，在许多定量指标下实现了最先进的状态。此外，通过汇总不同数量的生成的模糊样本，该框架使我们能够方便地超越图1所示的感知-失真曲线，而无需任何昂贵的重新训练或微调。

![](https://raw.githubusercontent.com/ShawnDong98/gitimage/main/小书匠/1670480162893.png)
