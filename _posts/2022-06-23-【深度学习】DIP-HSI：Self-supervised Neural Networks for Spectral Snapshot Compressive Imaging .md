---
layout:     post
title: 【深度学习】DIP-HSI：Self-supervised Neural Networks for Spectral Snapshot Compressive Imaging
subtitle:   ""
date:       2022-06-23
author:     "ShawnD"
...
这篇文章考虑使用未经训练的神经网络来解决快照压缩成像(SCI)的重建问题，它使用一个二维(2D)检测器以压缩的方式捕获一个高维(通常是3D)数据立方体。
